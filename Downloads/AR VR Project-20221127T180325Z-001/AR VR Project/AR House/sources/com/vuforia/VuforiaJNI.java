...
class VuforiaJNI {
    ...
    public static final native long CameraDevice_getCurrentVideoMode(long j, CameraDevice cameraDevice);
    ...
    public static final native boolean CameraDevice_init(long j, CameraDevice cameraDevice);
    ...
    public static final native boolean CameraDevice_setField__SWIG_4(long j, CameraDevice cameraDevice, String str, long j2, long j3);
    ...
    public static final native long CloudRecoSearchResult_SWIGUpcast(long j);

    public static final native long CloudRecoSearchResult_getClassType();

    public static final native String CloudRecoSearchResult_getMetaData(long j, CloudRecoSearchResult cloudRecoSearchResult);

    public static final native float CloudRecoSearchResult_getTargetSize(long j, CloudRecoSearchResult cloudRecoSearchResult);

    public static final native short CloudRecoSearchResult_getTrackingRating(long j, CloudRecoSearchResult cloudRecoSearchResult);
    ...
    public static final native long DataSet_createTrackable__SWIG_0(long j, DataSet dataSet, long j2, TrackableSource trackableSource);

    public static final native long DataSet_createTrackable__SWIG_1(long j, DataSet dataSet, long j2, RuntimeImageSource runtimeImageSource);
    ...
    public static final native String GuideView_getName(long j, GuideView guideView);
    ...
    public static final native long Illumination_getColorCorrection(long j, Illumination illumination);

    public static final native float Illumination_getIntensityCorrection(long j, Illumination illumination);
    ...
    public static final native long ImageTargetResult_getVirtualButtonResult(long j, ImageTargetResult imageTargetResult, String str);
    ...
    public static final native long ImageTarget_getVirtualButton(long j, ImageTarget imageTarget, String str);
    ...
    public static final native int ModelTarget_getActiveGuideViewIndex(long j, ModelTarget modelTarget);
    ...
    public static final native boolean ModelTarget_setActiveGuideViewIndex(long j, ModelTarget modelTarget, int i);
    ...
    public static final native long MultiTargetResult_getPartResult(long j, MultiTargetResult multiTargetResult, String str);
    ...
    public static final native long MultiTarget_getPart(long j, MultiTarget multiTarget, String str);
    ...
    public static final native int ObjectTarget_getMotionHint(long j, ObjectTarget objectTarget);
    ...
    public static final native boolean ObjectTarget_setMotionHint(long j, ObjectTarget objectTarget, int i);
    ...
    public static final native long ObjectTracker_getRuntimeImageSource(long j, ObjectTracker objectTracker);

    public static final native long ObjectTracker_getTargetFinder__SWIG_0(long j, ObjectTracker objectTracker, int i);

    public static final native long ObjectTracker_getTargetFinder__SWIG_1(long j, ObjectTracker objectTracker);
    ...
    public static final native boolean RuntimeImageSource_setFile(long j, RuntimeImageSource runtimeImageSource, String str, int i, float f, String str2);

    public static final native boolean RuntimeImageSource_setImage(long j, RuntimeImageSource runtimeImageSource, ByteBuffer byteBuffer, int i, long j2, Vec2I vec2I, float f, String str);

    public static final native long SmartTerrain_SWIGUpcast(long j);

    public static final native long SmartTerrain_getClassType();

    public static final native long SmartTerrain_hitTest(long j, SmartTerrain smartTerrain, long j2, Vec2F vec2F, int i, long j3, State state, float f);
    ...
    public static final native long TargetSearchResult_getType(long j, TargetSearchResult targetSearchResult);

    public static final native String TargetSearchResult_getUniqueTargetId(long j, TargetSearchResult targetSearchResult);

    public static final native boolean TargetSearchResult_isOfType(long j, TargetSearchResult targetSearchResult, long j2, Type type);
    ...
    public static final native int VideoMode_Format_get(long j, VideoMode videoMode);

    public static final native void VideoMode_Format_set(long j, VideoMode videoMode, int i);
    ...
    public static final native void delete_CloudRecoSearchResult(long j);
    ...
    public static final native void delete_RuntimeImageSource(long j);
