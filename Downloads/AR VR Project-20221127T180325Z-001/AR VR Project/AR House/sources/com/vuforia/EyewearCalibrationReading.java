...
public class EyewearCalibrationReading {
    ...
    protected static long getCPtr(EyewearCalibrationReading eyewearCalibrationReading) {
        if (eyewearCalibrationReading == null) {
            return 0;
        }
        return eyewearCalibrationReading.swigCPtr;
    }
    ...
    public Matrix34F getPose() {
        ...
        if (EyewearCalibrationReading_Pose_get == 0) {
            return null;
        }
        return new Matrix34F(EyewearCalibrationReading_Pose_get, false);
    }
