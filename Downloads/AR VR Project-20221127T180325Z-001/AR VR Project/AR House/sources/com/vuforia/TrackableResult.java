...
public class TrackableResult {
    ...
    public static final class STATUS_INFO {
        public static final int EXCESSIVE_MOTION = 4;
        public static final int INITIALIZING = 2;
        public static final int INSUFFICIENT_FEATURES = 5;
        public static final int INSUFFICIENT_LIGHT = 6;
        public static final int NORMAL = 0;
        public static final int NO_DETECTION_RECOMMENDING_GUIDANCE = 7;
        public static final int RELOCALIZING = 3;
